...
//actions - array
$actions = array('login', 'logout', 'addcategory', 'addproduct', 'deletecategory', 'deleteproduct', 'register');
$action = 'start';
...
//views - array
$views = array('start', 'login', 'products', 'addcategory', 'addproduct', 'deletecategory', 'deleteproduct', 'about', 'register');
$view = 'start';
